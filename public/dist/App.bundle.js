...
function loadPlaces(map) {
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        // create a bounds - which centers markers and places the zoom appropriately
        var bounds = new google.maps.LatLngBounds();
        // infoWindow - to display pop-ups on click on the pin
...
// Here it is possible to use the user's geolocation
...
// $ is a query selected, see imports
// this file is the entry point for javascript
// where webpack puts it all together
...
heartForms.on('submit', _heart.ajaxHeart);
